  ...
  module Session
    ...
    module Methods
      ...
      def validate_by_facebook_connect
        ...
        self.attempted_record = facebook_user_class.find(:first, :conditions => { facebook_uid_field => facebook_session.user.uid }) # TODO: What the hell was this code for? .try(:"#{klass}".to_s.underscore)
